...
import edu.wx.message.resp.Music;
...
public class AdvancedUtil {
	...
	public static String makeMusicCustomMessage(String openId, Music music) {
		...
		jsonMsg = String.format(jsonMsg, openId, new JSONObject(music).toString());
	...
	public static String makeNewsCustomMessage(String openId, List<Article> articleList) {
		...
		jsonMsg = String.format(jsonMsg, openId, new JSONArray(articleList).toString().replaceAll("\"", "\\\""));
