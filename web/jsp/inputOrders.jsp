...
<%
	...
	String flag = String.valueOf(request.getAttribute("orderflag"));
						...
						<div class="col-md-12 col-sm-12 col-xs-12">
							<div class="x_panel">
								...
								<div class="x_content">
									...
									<form action="<%=basePath%>ImportFileServlet?type=1" method="post">
										<button type="submit"
											class="btn btn-primary btn-lg btn-block" disabled="disabled" id="detect">开始导入</button>
									</form>
...
<%@ include file="footer.jsp" %>
	...
	<script type="text/javascript">
			...
			$(".dropzone").dropzone({
				url: "<%=path %>/UploadServlet?type=1",
        		maxFiles: 1,
        		maxFilesize: 100,
        		acceptedFiles: ".csv",
        		dictDefaultMessage: "请拖拽或单击窗口上传csv格式的订单信息文件",
        		dictFallbackMessage: "您的浏览器不支持拖拽文件上传",
      			dictFileTooBig: "您上传的文件过大 ({{filesize}}MB). 最大文件大小: {{maxFilesize}}MB.",
